...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for data_dict in models.get('Contributor', []):
            c, created = Contributor.objects.get_or_create(first_name=data_dict['contributor_first_name'],
        ...
        for data_dict in models.get('Review', []):
            ...
            review, created = Review.objects.get_or_create(comment=data_dict['review_comment'],
                                                           book=book,
                                                           creator=creator,
                                                           defaults={
